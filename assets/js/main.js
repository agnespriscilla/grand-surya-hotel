...
// Tambahan untuk sidebar effect pada slicknav
$(document).on('click', '.slicknav_btn', function() {
  var $menu = $(this).closest('.slicknav_menu');
...
// Tutup sidebar jika klik di luar menu (overlay)
$(document).on('click', function(e) {
  if ($(window).width() < 768) {
    if ($('body').hasClass('slicknav-open')) {
